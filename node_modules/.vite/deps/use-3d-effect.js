...
// node_modules/use-3d-effect/dist/index.es.js
...
function useBoundingClientRect(ref) {
  var _a = (0, import_react.useState)(initialBounds), bounds = _a[0], set = _a[1];
  var ro = (0, import_react.useState)(function() {
...
var use3dEffect = function(ref) {
  ...
  return {
    ...
    // @ts-ignore
    onMouseMove: function(_a2) {
      var x = _a2.pageX, y = _a2.pageY;
...
//# sourceMappingURL=use-3d-effect.js.map
