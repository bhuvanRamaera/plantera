...
function useBoundingClientRect(ref) {
    var _a = react.useState(initialBounds), bounds = _a[0], set = _a[1];
    var ro = react.useState(function () {
...
var use3dEffect = function (ref) {
    var _a = reactSpring.useSpring(function () { return ({
        xys: [0, 0, 1],
...
exports.use3dEffect = use3dEffect;
